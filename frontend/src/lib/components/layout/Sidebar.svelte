<script lang="ts">
  ...
  const icons: Record<string, string> = {
    ...
    agency:     'M12 3l2.2 4.5 4.9.7-3.55 3.45.84 4.85L12 14.2 7.61 16.5l.84-4.85L4.9 8.2l4.9-.7L12 3z',
  ...
  const adminNav = [
    ...
    { href: '/agency',     icon: 'agency',     label: 'AI Agency',  perm: 'automation.trigger' },
