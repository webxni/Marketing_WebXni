...
const CLIENT_BLOG_TEMPLATES: Record<string, Omit<BlogTemplateConfig, 'clientSlug'>> = {
  ...
  'americas-professional-builders': {
    ...
    audience: 'Los Angeles homeowners planning remodeling, repairs, and coordinated home improvements',
    tone: 'experienced, steady, contractor-led',
    authorLabel: 'America’s Professional Builders Inc',
    categoryLabel: 'Construction Guidance',
    primaryColor: '#1e3a5f',
    accentColor: '#c8a04a',
    quickFacts: ['Project scope and site planning', 'Trade coordination', 'Clear construction communication'],
    relatedServices: ['Kitchen Remodeling', 'Bathroom Remodeling', 'HVAC & Insulation', 'Roofing'],
  ...
  'elite-team-builders': {
    ...
    industryLabel: 'Construction',
    audience: 'homeowners in California, Oregon, and Washington planning substantial home improvements',
    tone: 'professional, transparent, detail-oriented, practical',
    authorLabel: 'Elite Team Builders Inc.',
    categoryLabel: 'Remodeling Insight',
    primaryColor: '#1a1a2e',
    accentColor: '#c8a04a',
    quickFacts: ['Project scope and site planning', 'Permit and utility coordination', 'Clear construction communication'],
    relatedServices: ['Kitchen Remodeling', 'Bathroom Remodeling', 'ADU Construction', 'Room Additions'],
    shareTitle: 'Home improvement planning guide',
  },
