...
export function withImplicitBlogPlatform<T extends Pick<ClientRow, 'id' | 'wp_base_url' | 'wp_url'> | null | undefined>(
  ...
  return [
    ...clientPlatforms,
    {
      ...
      yt_channel_id: null,
      linkedin_urn: null,
      verification_status: hasWordPress ? 'verified' : 'unverified',
...
export function withImplicitGbpPlatform(
  ...
  return [
    ...clientPlatforms,
    {
      ...
      yt_channel_id: null,
      linkedin_urn: null,
      verification_status: primaryLocation.verification_status,
      provider_destination_id: primaryLocation.location_id,
      verified_business_name: primaryLocation.verified_business_name,
      verified_phone: primaryLocation.verified_phone,
      verified_market: primaryLocation.verified_market,
      verified_at: primaryLocation.verified_at,
      verification_notes: primaryLocation.verification_notes,
      paused: 0,
      paused_reason: null,
      paused_since: null,
