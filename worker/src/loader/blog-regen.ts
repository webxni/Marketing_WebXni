...
export async function executeBlogRegenSlot(
  ...
  try {
    ...
    await updatePost(db, slot.post_id, {
      ...
      cap_instagram:       withUrl(p.cap_instagram       ?? undefined),
      cap_x:               withUrl(p.cap_x               ?? undefined),
      cap_threads:         withUrl(p.cap_threads         ?? undefined),
      cap_pinterest:       withUrl(p.cap_pinterest       ?? undefined),
      cap_bluesky:         withUrl(p.cap_bluesky         ?? undefined),
